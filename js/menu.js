...
document.getElementById("ginecologia").onclick = function () {
  window.location.href = "Ginecologia.html";
  
}; 

document.getElementById("pediatria").onclick = function () {
  window.location.href = "Pediatria.html";
  
}; 

document.getElementById("nutricion").onclick = function () {
  window.location.href = "Nutricion.html";
  
}; 
document.getElementById("psicologia").onclick = function () {
  window.location.href = "Psicologia.html";
  
}; 
document.getElementById("gastroenterologia").onclick = function () {
  window.location.href = "Gastroenterologia.html";
  
}; 
document.getElementById("otorrinolaringologia").onclick = function () {
  window.location.href = "Otorrinolaringologia.html";
  
}; 

document.getElementById("cardiologia").onclick = function () {
